...
export default function SupervisorEvaluations() {
  ...
  return (
      <Box maxWidth="100%" mx="auto" py={3} px={0} pt={0}>
        <DashboardSectionHeader>
          Evaluation & Rubrics
        </DashboardSectionHeader>

        <div className="section-desc">
          Here you can see provide evaluation & rubrics. Select "Particular Group and milestone" to add the numbers and then submit evaluation,
          and you can also see your all evaluations allotted.
        </div>
